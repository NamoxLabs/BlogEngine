...
if (process.env.NODE_ENV === 'production') {
  ...
  output = {
    path: resolve('engine/static/assets/'),
...
var config = {
  entry: {
    dashboard: './engine/static/dashboard/js/dashboard.js',
    'dashboard-next': './engine/static/dashboard-next/index.tsx',
  },
  output: output,
  module: {
    rules: [
      ...
      },
      {
        ...
        include: [
          ...
          resolve('engine/static/fonts'),
          resolve('engine/static/images'),
          resolve('engine/static/dashboard/images')
        ]
      }
    ]
  },
